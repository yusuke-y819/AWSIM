...
namespace AWSIM
{
    ...
    /// </summary>
    public class EventCameraSensor : MonoBehaviour
    {
        /// <summary>
        /// Camera Parameters
        /// fx, fy = focal length.
        ...
        [System.Serializable]
        public class EVSCameraParameters
        {
            /// <summary>
            /// Image height.
            /// </summary>
        ...
        public class OutputData
        {
            ...
            /// </summary>
            public EVSCameraParameters cameraParameters;
        }

        [System.Serializable]
        public class EVSImageOnGui
        {
            /// <summary>
        ...
        [SerializeField] EVSImageOnGui imageOnGui = new EVSImageOnGui();

        [SerializeField] EVSCameraParameters cameraParameters;
        ...
        [SerializeField] ComputeShader evsDistortionShader;
        ...
        void Start()
        {
            ...
            shaderKernelIdx = evsDistortionShader.FindKernel("EVSDistortTexture");
            ...
            evsDistortionShader.GetKernelThreadGroupSizes(shaderKernelIdx,
        ...
        public void DoRender()
        {
            ...
            evsDistortionShader.SetTexture(shaderKernelIdx, "_InputTexture", targetRenderTexture);
            evsDistortionShader.SetTexture(shaderKernelIdx, "_pre_image", GrayRenderTexture);

            evsDistortionShader.SetTexture(shaderKernelIdx, "_DistortedTexture", distortedRenderTexture);
            evsDistortionShader.SetTexture(shaderKernelIdx, "_Output_pre_image", GrayRenderTexture);


            evsDistortionShader.Dispatch(shaderKernelIdx, distortionShaderGroupSizeX, distortionShaderGroupSizeY, 1);
        ...
        private void UpdateRenderTexture()
        {
            targetRenderTexture = new RenderTexture(
                1920, 1080, 32, RenderTextureFormat.BGRA32);
        ...
        {
            evsDistortionShader.SetInt("_width", cameraParameters.width);
            evsDistortionShader.SetInt("_height", cameraParameters.height);
            evsDistortionShader.SetFloat("_fx", cameraParameters.fx);
            evsDistortionShader.SetFloat("_fy", cameraParameters.fy);
            evsDistortionShader.SetFloat("_cx", cameraParameters.cx);
            evsDistortionShader.SetFloat("_cy", cameraParameters.cy);
            evsDistortionShader.SetFloat("_k1", -cameraParameters.k1); // TODO: Find out why 'minus' is needed for proper distortion
            evsDistortionShader.SetFloat("_k2", -cameraParameters.k2); // TODO: Find out why 'minus' is needed for proper distortion
            evsDistortionShader.SetFloat("_p1", cameraParameters.p1);
            evsDistortionShader.SetFloat("_p2", -cameraParameters.p2); // TODO: Find out why 'minus' is needed for proper distortion
            evsDistortionShader.SetFloat("_k3", -cameraParameters.k3); // TODO: Find out why 'minus' is needed for proper distortion
