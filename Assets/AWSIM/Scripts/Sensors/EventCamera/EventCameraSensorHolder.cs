...
namespace AWSIM
{
    ...
    /// </summary>
    public class EventCameraSensorHolder : MonoBehaviour
    {
        [Header("Camera Sensors")]
        [SerializeField] private List<EventCameraSensor> cameraSensors = default;
        ...
        /// </summary>
        [Range(0, 100)][SerializeField] private uint publishHz = 100;
    ...
    /// <param name="wait">Set True if wait to end of the frame after render.</param>
        private IEnumerator RenderCamera(EventCameraSensor cameraSensor, bool wait) 
        {
